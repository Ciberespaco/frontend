// ~/components/pdv/AutoFormProductSearch.vue (Código Corrigido)
...
<template>
  <FormField v-slot="{ componentField, value }" :name="fieldName">
    <FormItem>
      <Popover v-model:open="open">
        ...
        <PopoverContent class="w-[--radix-popover-trigger-width] p-0">
          <Command :should-filter="false">
            <CommandInput v-model="searchTerm" placeholder="Buscar produto..." />
            <CommandList>
              <CommandEmpty>
