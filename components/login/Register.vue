  ...
  >
    ...
    <FormField name="name">
      <FormItem>
        ...
        <FormControl><Input v-model="name" type="text" /></FormControl>
    ...
    <FormField name="email">
      <FormItem>
        ...
        <FormControl><Input v-model="email" type="email" /></FormControl>
    ...
    <FormField name="password">
      <FormItem>
        ...
        <FormControl><Input v-model="password" type="password" /></FormControl>
