...
<template>
    <AuthForm title="Criar Conta" subtitle="Preencha os campos abaixo para criar uma nova conta."
        submitLabel="Criar Conta" :loading="loading" :apiError="apiError" :onSubmit="onSubmit" secondary-href="/login"
        secondary-label="Entrar">
        <!-- fields -->
        <FormField name="name">
            <FormItem>
                <FormLabel>Nome Completo</FormLabel>
                <FormControl><Input type="text" v-model="name" /></FormControl>
        ...
        <FormField name="email">
            <FormItem>
                ...
                <FormControl><Input type="email" v-model="email" /></FormControl>
        ...
        <FormField name="password">
            <FormItem>
                ...
                <FormControl><Input type="password" v-model="password" /></FormControl>
        ...
        <FormField name="passwordConfirmation">
            <FormItem>
                ...
                <FormControl><Input type="password" v-model="passwordConfirmation" /></FormControl>
